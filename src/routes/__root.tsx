...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AIRBRIDGE — Secure International Traveler Delivery" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "AIRBRIDGE" },
      { property: "og:title", content: "AIRBRIDGE — Secure International Traveler Delivery" },
      {
        property: "og:description",
        content: "Eligibility checks, verified travelers, QR + OTP handover and a transparent chain of custody.",
      },
